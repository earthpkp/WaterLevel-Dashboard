...
- 📡 **นำเข้าข้อมูล Observe จาก API ของ กรมชลประทาน (รองรับช่วงวันที่)**
- 📤 **นำเข้าข้อมูล Forecast จากไฟล์ CSV**
...
### Import Data from RID API (NEW!)
```
POST /api/import/observe
```
นำเข้าข้อมูล Observe จาก API ของ กรมชลประทาน  
**รองรับการดึงข้อมูลแบบช่วงวันที่!**
...
```json
{
  ...
  "endDate": "13/11/2568"  // optional - ถ้าไม่ระบุจะดึงแค่วันเดียว
}
```
...
📖 **รายละเอียดเพิ่มเติม:** [API_DATE_RANGE_GUIDE.md](API_DATE_RANGE_GUIDE.md)

### Import Forecast Data from CSV (NEW!)
```
POST /api/import/forecast/csv
```
นำเข้าข้อมูล Forecast จากไฟล์ CSV
...
📖 **รายละเอียดเพิ่มเติม:** [CSV_IMPORT_GUIDE.md](CSV_IMPORT_GUIDE.md)
